...
\else % if luatex or xelatex
  ...
  \newcommand{\euro}{€}
  \setmainfont[Path=\string./CommonFiles/,
  BoldFont=ACaslonPro-Bold.otf,
  ItalicFont=ACaslonPro-Italic.otf,
  BoldItalicFont=ACaslonPro-BoldItalic.otf]{ACaslonPro-Regular.otf}
  \setsansfont[Path=\string./CommonFiles/,
...
\newfontfamily{\myriadpcondensed}[Path=\string./CommonFiles/]{MyriadPro-Cond.otf}
\newfontfamily{\myriadpcondensedbold}[Path=\string./CommonFiles/]{MyriadPro-BoldCond.otf}
